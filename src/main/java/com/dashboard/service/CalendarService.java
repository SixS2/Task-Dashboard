        ...
        try {
            ...
            for (Object componentObj : calendar.getComponents(Component.VEVENT)) {
                ...
                if (dtStart != null && dtStart.getDate() != null) {
                    ...
                    ZonedDateTime eventDate = ZonedDateTime.ofInstant(dtStart.getDate().toInstant(),
                    ...
                    if (dtEnd != null && dtEnd.getDate() != null) {
                        ZonedDateTime endDate = ZonedDateTime.ofInstant(dtEnd.getDate().toInstant(),
                                ZoneId.systemDefault());
                    ...
                    ZonedDateTime deadline = dto.getEndDateTime() != null ? dto.getEndDateTime()
